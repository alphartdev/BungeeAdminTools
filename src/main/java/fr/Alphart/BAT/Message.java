...
public class Message {
	...
	public static final String OFFLINE_PLAYER = "The player is not connected.";
	...
	public static final String UNMUTE_BROADCAST = "&a%entity%&e was &6unmuted &eby &a%staff%&e from the server &a%serv%&e. Reason : %reason%";
